...
(function() {
  ...
  angular.module(SERVICE_MODULE).service('GameConstants', function() {
    this.constants = {};
  ...
  angular.module(DIRECTIVE_MODULE).directive("toonLog", function($rootScope, GameConstants) {
    var directive;
    return directive = {
      replace: true,
      scope: {
      ...
      link: function(scope) {
        var createdDate, logTypes, now, parseDate;
        ...
        switch (scope.item.LogType) {
          case logTypes.fight:
            ...
            break;
          case logTypes.locationDiscovery:
  ...
  app = angular.module(APP_NAME, ["" + APP_NAME + ".directives", "" + APP_NAME + ".services"]).run(function($rootScope, $http, GameConstants) {
  ...
  angular.module(APP_NAME).controller('HomeCtrl', function($scope, $rootScope, $http, $timeout, GameConstants) {
    ...
    drawLocations = function() {
      ...
      sortedLocations = _.sortBy($rootScope.displayedLocations, function(loc) {
